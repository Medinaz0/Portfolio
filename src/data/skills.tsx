...
export const skills: Skill[] = [
  {
    ...
    detail: {
      proficiency: 95,
      years: 4,
      descriptionKey: "skills.technical_descriptions.python",
      related: ["FastAPI", "Pandas", "Scripting"],
    },
  },
  {
    name: "Bash",
    ...
    detail: {
      proficiency: 90,
      years: 2,
      descriptionKey: "skills.technical_descriptions.bash",
      related: ["Shell Scripting", "Linux", "Regex"],
    },
  },
  {
    name: "Java",
    ...
    detail: {
      proficiency: 65,
      years: 2,
      descriptionKey: "skills.technical_descriptions.java",
      related: ["Spring Boot", "Maven", "OOP"],
    },
  },
  {
    name: "Spring Boot",
    ...
    detail: {
      proficiency: 55,
      years: 2,
      descriptionKey: "skills.technical_descriptions.spring_boot",
      related: ["REST APIs"],
    },
  },
  {
    ...
    detail: {
      proficiency: 80,
      years: 4,
      descriptionKey: "skills.technical_descriptions.postgresql",
      related: ["SQL", "Data Modeling", "pgAdmin", "Trigger Functions", "pl/pgSQL"],
    },
  },
  {
    name: "AWS",
    ...
    detail: {
      proficiency: 70,
      years: 1,
      descriptionKey: "skills.technical_descriptions.aws",
      related: ["EC2", "S3", "IAM", "Security Groups"],
    },
  },
  {
    name: "Azure",
    ...
    detail: {
      proficiency: 60,
      years: 1,
      descriptionKey: "skills.technical_descriptions.azure",
      related: ["Virtual Machines", "Blob Storage", "Network Security Groups"],
    },
  },
  {
    name: "VM",
    ...
    detail: {
      proficiency: 90,
      years: 4,
      descriptionKey: "skills.technical_descriptions.vm",
      related: ["VirtualBox", "VMware"],
    },
  },
  {
    name: "Docker",
    ...
    detail: {
      proficiency: 60,
      years: 1,
      descriptionKey: "skills.technical_descriptions.docker",
      related: ["Containers", "Compose", "Images"],
    },
  },
  {
    name: "jenkins",
    ...
    detail: {
      proficiency: 50,
      years: 1,
      descriptionKey: "skills.technical_descriptions.jenkins",
      related: ["CI/CD", "Pipelines", "Automation"],
    },
  },
  {
    name: "Git",
    ...
    detail: {
      proficiency: 95,
      years: 4,
      descriptionKey: "skills.technical_descriptions.git",
  ...
  },
  {
    ...
    detail: {
      proficiency: 85,
      years: 4,
      descriptionKey: "skills.technical_descriptions.github",
      related: ["Actions", "Pull Requests", "Collaboration"],
    },
  },
  {
    name: "API",
    ...
    detail: {
      proficiency: 80,
      years: 3,
      descriptionKey: "skills.technical_descriptions.api",
      related: ["REST", "HTTP", "JSON"],
    },
  },
  {
    name: "Cybersecurity",
    ...
    detail: {
      proficiency: 75,
      years: 2,
      descriptionKey: "skills.technical_descriptions.cybersecurity",
      related: ["Vulnerability Analysis", "ParrotOS", "Linux"],
    },
  },
  {
    name: "SCRUM",
    ...
    detail: {
      proficiency: 60,
      years: 1,
      descriptionKey: "skills.technical_descriptions.scrum",
      related: ["Agile", "Sprints", "Jira"],
    },
  },
  {
    name: "Reporting",
    ...
    detail: {
      proficiency: 65,
      years: 2,
      descriptionKey: "skills.technical_descriptions.reporting",
      related: ["Dashboards", "Data Analysis", "Excel", "Power BI", "Weka", "Hadoop (hdfs)"],
    },
  },
];
