        ...
        <div className="relative z-50 w-72 bg-zinc-900 border border-zinc-800 rounded-lg p-5 shadow-xl">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <svg viewBox="0 0 268.152 273.883" className="w-5 h-5 text-emerald-400 shrink-0" fill="currentColor">
                <defs>
                  <clipPath id="gmail_clip" clipPathUnits="userSpaceOnUse">
                ...
                <g clipPath="url(#gmail_clip)" transform="matrix(.95792 0 0 .98525 -90.174 -78.856)">
                  <path d="M92.076 219.958c.148 22.14 6.501 44.983 16.117 63.424v.127c6.949 13.392 16.445 23.97 27.26 34.452l65.327-23.67c-12.36-6.235-14.246-10.055-23.105-17.026-9.054-9.066-15.802-19.473-20.004-31.677h-.17l.17-.127c-2.765-8.058-3.037-16.613-3.14-25.503Z"/>
                  <path d="M237.083 79.025c-6.456 22.526-3.988 44.421 0 57.161 7.457.006 14.64.888 21.45 2.647a77.662 77.662 0 0 1 33.424 18.25l41.88-40.726c-24.81-22.59-54.667-37.297-96.754-37.332Z"/>
                  <path d="M236.943 78.847c-31.67 0-60.91 9.798-84.871 26.359a145.533 145.533 0 0 0-24.332 21.15c-1.904 17.744 14.257 39.551 46.262 39.37 15.528-17.936 38.495-29.542 64.056-29.542l.07.002-1.044-57.335c-.048 0-.093-.004-.14-.004Z"/>
                  ...
                  <path d="M234.996 191.21v57.498h136.006c1.196-7.874 5.152-18.064 5.152-26.5 0-9.858-.996-21.899-2.687-30.998Z"/>
                  ...
                  <path d="M162.099 155.857c22.112 13.301 28.471-6.714 43.173-12.977l-25.574-52.664a144.74 144.74 0 0 0-26.543 14.504c-12.316 8.512-23.192 18.9-32.176 30.72Z"/>
                  <path d="M171.099 290.222c-29.683 10.641-34.33 11.023-37.062 29.29a144.806 144.806 0 0 0 16.792 13.984c15.996 11.386 46.766 26.551 86.118 26.551.046 0 .09-.004.137-.004v-59.157l-.094.002c-14.736 0-26.512-3.843-38.585-10.527-2.977-1.648-8.378 2.777-11.123.799-3.786-2.729-12.9 2.35-16.183-.938Z"/>
                  <path d="M219.7 299.023v59.996c5.506.64 11.236 1.028 17.247 1.028 6.026 0 11.855-.307 17.52-.872v-59.748a105.119 105.119 0 0 1-17.477 1.461c-5.932 0-11.7-.686-17.29-1.865Z" opacity=".5"/>
                </g>
              </svg>
            ...
            <div className="flex items-center gap-3">
              <svg viewBox="0 0 92.3 132.3" className="w-5 h-5 text-emerald-400 shrink-0" fill="currentColor">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a
                  href="https://www.linkedin.com/in/medinaz0/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-mono text-sm text-white hover:text-emerald-400 transition-colors"
                >
